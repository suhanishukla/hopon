...
export default function RideCard({ rideId, ridename, startLocation, endLocation, date, time, currentPassengers, totalPassengers, passengerList, additionalInfo, isCreator, isJoined }) {
  const bull = (
    <Box
      component="span"
